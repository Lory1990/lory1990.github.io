...
const PodcastCard: React.FC<IPodcastCardProps> = ({
  title,
  date,
  image,
  link,
  ...
  return (
    ...
    >
      ...
      {open &&
        <Box dangerouslySetInnerHTML={{__html: description.replace("\n--- \n\nSend in a voice message: https://anchor.fm/lory1990/message", "")}}>
        </Box>
      }
    </Card>
  );
