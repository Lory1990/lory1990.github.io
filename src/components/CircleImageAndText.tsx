...
const CircleImageAndText: React.FC<ICircleImageAndTextProps> = ({
  title,
  image,
  description,
  deltaSaturation = 5
  ...
  return (
    ...
    >
      ...
      <Box className="media-body">
        {title && (
          <Box
            sx={{ fontWeight: "300", fontSize: "1.5em" }}
        ...
        {description && (
          <Box sx={{ marginTop: "0.5em", fontWeight: "200" }}>
            {description}
          </Box>
        )}
      </Box>
