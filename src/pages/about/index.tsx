...
const TechStackBand: React.FC<ITechStackBandPros> = ({
  inverted,
  techStack,
  title,
  image,
    ...
    <div>
      ...
      <PageWrapper>
        <Fade direction="top-left">
          <SectionTitle sx={{ marginBottom: "1em", marginTop: "1em" }}>
            My Stack
          </SectionTitle>
        </Fade>
        <Box
        ...
        >
          <TechStackBand
            inverted={false}
            image={"/img/about/frontend.svg"}
            title="Frontend"
            techStack={techStack.filter((ts) => ts.category == "FE")}
            initialDelay={200}
          />
          <TechStackBand
            inverted={true}
            image={"/img/about/backend.svg"}
            title="Backend"
            techStack={techStack.filter((ts) => ts.category == "BE")}
            initialDelay={0}
          />
          <TechStackBand
            inverted={false}
            image={"/img/about/cloud.svg"}
            title="Cloud"
            techStack={techStack.filter((ts) => ts.category == "CLOUD")}
          />
        </Box>
        <Bounce>
          <CTABand
