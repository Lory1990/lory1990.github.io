                ...
                <TextImageBand
                    ...
                    text={
                        <>
                            ...
                            Moreover I participate as guarst or speaker to online and offline community events such as Google Developer Fests, Tech Meetups and Cloud Native Speech, you can see all my
                            events to the <Link href="/events">dedicated page</Link>. <br />
                            Last but not least I have also host my own podcast where I delve with cloud software architecture, microservices and frontend development, start listening using the bottom
                            links. <br />
                            <Box
                                sx={{
                                    marginTop: "1em",
