...
const career: TimelineEvent[] = [
  ...
  },
  {
    ...
    to: "May 2020",
    description:
      "Development of Cryptoforecast platform, consisting of an application, backoffice, and web jobs, while also serving as a Financial Forecast Algorithms Developer and Project Manager.",
  },
  {
    ...
    to: "August 2018",
    description:
      "Integrated Logistic Support Technical Writer for the Italian Navy with skills in supplier management, spare parts identification and supply, and writing use and maintenance manuals for complex systems.",
  },
  {
    ...
    to: "December 2016",
    description:
      "Co-founder of a startup with focus on development of decision support products for the large cruise shipping market. Navium has been founded by the POR-FESR 2020 Program - 300k\u20AC.",
  },
]
